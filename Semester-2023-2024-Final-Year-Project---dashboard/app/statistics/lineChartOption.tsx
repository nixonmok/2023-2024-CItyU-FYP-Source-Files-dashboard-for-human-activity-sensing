        ...
        <div className=" flex flex-col w-full">
            ...
            <form className="flex flex-col" onSubmit={(e) => handleFormSubmit(e)}>
                ...
                {selectedXAxis.localeCompare('') !== 0 &&
                    <>
                        <button id="submit-button" disabled={isNaN(parseInt(keyValuePairs.find((pairs)=>{return pairs.key === selectedXAxis})?.value ??""))}  className="bg-blue-700 text-white font-bold rounded-md mt-5 py-2 hover:bg-blue-400 transition active:bg-violet-800 disabled:cursor-not-allowed disabled:bg-gray-300"
                            type="submit"
                            >                            
                                Submit
                        </button>
